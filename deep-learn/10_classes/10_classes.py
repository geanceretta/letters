...
lista_treino = []
lista_teste = []
class_names = ['a', 'b', 'c', 'e', 'k', 'o', 'y', 'x', 'm', 'n']
train_images = np.zeros((387*10, 32, 32, 4))
test_images = np.zeros((43*10, 32, 32, 4))
train_labels = np.zeros((387*10, 1))
test_labels = np.zeros((43*10, 1))
...
for i in range(len(lista_treino)):
        ...
        if(lista_treino[i][1] == '8'):
            train_labels[id_treina] = 8
        if(lista_treino[i][1] == '0'):
            train_labels[id_treina] = 9            
        id_treina += 1
...
for i in range(len(lista_teste)):
        ...
        if(lista_teste[i][1] == '8'):
            test_labels[id_treina] = 8
        if(lista_teste[i][1] == '0'):
            test_labels[id_treina] = 9            
        id_treina += 1
